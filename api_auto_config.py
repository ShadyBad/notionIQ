...
class APIAutoConfigurator:
    ...
    def auto_configure(self) -> Dict[str, Any]:
        ...
        config = {
            ...
            "estimated_cost_per_100": self._estimate_cost(selected_model, optimization_level),
    ...
    def _estimate_cost(
        ...
        # Calculate per page
        cost_per_page = (
            (avg_input_tokens / 1_000_000) * input_cost +
            (avg_output_tokens / 1_000_000) * output_cost
        )
